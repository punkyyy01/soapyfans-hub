  ...
  public: {
    Tables: {
      ...
      review_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "review_likes_music_review_id_fkey"
            columns: ["music_review_id"]
            isOneToOne: false
            referencedRelation: "music_reviews"
            referencedColumns: ["id"]
          },
          {
      ...
      review_replies: {
        ...
        Relationships: [
          {
            foreignKeyName: "review_replies_music_review_id_fkey"
            columns: ["music_review_id"]
            isOneToOne: false
            referencedRelation: "music_reviews"
            referencedColumns: ["id"]
